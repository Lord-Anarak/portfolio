...
const experiences = [
  ...
  {
    title: "Web Developer",
    company_name: "SpectraCube",
    icon: spectra,
    iconBg: "#383E56",
    date: "Aug 2018 - May 2022",
    points: [
      "Designed and maintained responsive websites and applications, optimizing performance and user engagement.",
      "Worked closely with design and backend teams to implement front-end features and integrate APIs.",
      "Collaborated with cross-functional teams to deliver user-focused solutions.",
      "Ensured compatibility across browsers and devices with thorough testing and debugging.",
      "Utilized modern web development frameworks and best practices to enhance user experiences.",
    ],
  },
  {
